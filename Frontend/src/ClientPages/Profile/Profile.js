 ...
 // 
      ...
      try {
        ...
        if (clientId) {
          const response = await axios.get(
            `https://service-mangement-final-rxc3.onrender.com/services/client/${clientId}`
          );
  ...
  const fetchReservations = async () => {
    try {
      ...
      const response = await axios.get(
        `https://service-mangement-final-rxc3.onrender.com/reservationservices/reservations/client/${clientData.id}`
      );
    ...
    if (
      ...
      try {
        const response = await axios.put(
          `https://service-mangement-final-rxc3.onrender.com/clients/update/${clientData.id}`,
          updatedData
        );
        if (response.status === 200) {
  ...
  const handleJobRequestSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://service-mangement-final-rxc3.onrender.com/services/create",
        requestData
      );
  ...
  const handleDelete = async (jobId) => {
    try {
      const response = await axios.delete(
        `https://service-mangement-final-rxc3.onrender.com/services/delete/${jobId}`
      );
      if (response.status === 200) {
...
const handleAccept = async (reservationId) => {
  try {
    const response = await axios.patch(
      `https://service-mangement-final-rxc3.onrender.com/reservationservices/reservations/${reservationId}/status`,
      { status: "APPROVED" }
    );
    if (response.status === 200) {
...
////History
  const toggleHistory = async () => {
    if (!showHistory) {
      try {
        const response = await axios.get(
          `https://service-mangement-final-rxc3.onrender.com/services/client/${clientData.id}`
        );
        if (response.status === 200) {
          setJobHistory(response.data || []);
        }
